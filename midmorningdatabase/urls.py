"""
URL configuration for midmorningdatabase project.
...
urlpatterns = [
    ...
    path('add-pri=oduct/', user_views.add_product, name='add-product-page'),
    path('products/', user_views.product, name='all-products'),
